...
public class TC23_VerifyCreditCardPaymentFunctionInformationFailed {
    WebDriver driver;
    String url;
    SetUp setUp;
    HomePage homePage;
    ...
    public void setUp() {
        ...
        creditCard = CreditCard.getSampleCreditCardError();
        // information search
    ...
    public void TC23() {
        ...
        // Xác nhận message error
        softAssert.assertEquals(checkOutPage.getMessageError(),"Wrong CreditCard information !!!","Message Error dose not exits");
