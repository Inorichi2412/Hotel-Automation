...
public class TC3_VerifyThatTheSearchFunctionOfTheSearchTextboxOnTheHomeRoomAboutBlogsContactUsBlogsScreensIsNoSuccessful {
    ...
    @Test
    public void TC3() {
        homePage.textBoxSearchHomeNoSuccess();
        roomsPage.textBoxSearchRoomsNoSuccess();
        aboutPage.textBoxSearchAboutNoSuccess();
        blogsPage.textBoxSearchBlogNoSuccess();
        contanctPage.textBoxSearchContactNoSuccess();
        faqsPage.textBoxSearchFaqsNoSuccess();
    }
